...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddNote = __webpack_require__(224);
	...
	var NotesList = React.createClass({
	  ...
	  render: function render() {
	    var notes = this.props.notes.map(function (note, index) {
	      // '.value as note is actually an object and we want the .value property'
	      return React.createElement(
	        'li',
	  ...
	  _createClass(AddNote, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement("input", { type: "text", placholder: "add new note", className: "form-control", ref: this.setRef.bind(this) }),
	        React.createElement(
	          "span",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchGithub = React.createClass({
	  ...
	  handleSubmit: function handleSubmit() {
	    ...
	    // Router.History mixin adds the property `history` to our component
